...
// import { Bell, Calendar, ClipboardList, Pill, LayoutDashboard, Menu, LogOut, FileText, User } from "lucide-react";
...
//                     <li><Link to="/patient/medical-history" className="block p-2 bg-teal-600 hover:bg-teal-700 rounded flex items-center" onClick={handleLinkClick}><FileText className="mr-2" /> Medical History</Link></li>
